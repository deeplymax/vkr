...
const (
    AgentIdentificationEnvironmentKey    = "JUDGE_AGENT_ID"
    ExtraConfigurationFileEnvironmentKey = "JUDGE_AGENT_CONFIGURATION"
)

const (
    ConfigurationFileName = "judge-agent-configuration.json"
